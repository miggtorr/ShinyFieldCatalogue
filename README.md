...
**NO AI** was used for ANY Art or Text (including this readme!). All custom art (e.g., the app icon, sprite placeholders, etc.) was made by hand in Adobe Illustrator (by me! ❤️). All Pokémon sprites are taken from the PokéAPI and the Alpha icon is from Bulbapedia.
